...
int main(void)
{
	...
	data.textures[0] = mlx_xpm_file_to_image(data.mlx, "./textures/star.xpm", &i[0], &i[1]);
	data.textures[1] = mlx_xpm_file_to_image(data.mlx, "./textures/oiram.xpm", &i[0], &i[1]);
	data.textures[2] = mlx_xpm_file_to_image(data.mlx, "./textures/pipe.xpm", &i[0], &i[1]);
	data.textures[3] = mlx_xpm_file_to_image(data.mlx, "./textures/brick.xpm", &i[0], &i[1]);
	data.textures[4] = mlx_xpm_file_to_image(data.mlx, "./textures/BG.xpm", &i[0], &i[1]);
